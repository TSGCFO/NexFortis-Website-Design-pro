...
export function createStaticServer({
  ...
  return http.createServer((req, res) => {
    // Optional in-memory API routes used by the marketing prerender to resolve
    // same-origin `/api/*` fetches (e.g. blog post lookups). Each entry is
    // `[urlPattern, handler(req, res, match) => void]`. Handlers are
    // responsible for writing the full response.
    if (apiRoutes) {
