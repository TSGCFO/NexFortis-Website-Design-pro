...
- Step 2: Update home page (featured services with strikethrough prices, hero promo banner, starting-at price, comparison footnote)
- Step 3: Enhance service detail page pricing (promo badge, /mo suffix, trust badges, volume pack per-conversion, 10-Pack callout)
