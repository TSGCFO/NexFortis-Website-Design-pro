    ...
    <Layout>
      <Suspense fallback={<PageFallback />}>
        <Switch>
          ...
          <Route path="/services/digital-marketing/seo/ottawa">{() => <GeoServicePage service="seo" city="ottawa" />}</Route>
          ...
          <Route path="/services/digital-marketing/web-design/brampton">{() => <GeoServicePage service="web-design" city="brampton" />}</Route>
