...
export default function AutomationSoftware() {
  ...
  return (
    <div>
      <SEO title="Workflow Automation & Software Dev" description="Eliminate manual data entry with Power Automate, Zapier, and custom API integrations. NexFortis builds web apps and automated workflows for Canadian SMBs." path="/services/workflow-automation" />
