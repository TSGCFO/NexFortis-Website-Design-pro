...
export default function Microsoft365() {
  ...
  return (
    <div>
      <SEO title="Microsoft 365 Deployment & Security" description="Microsoft AI Cloud Partner: zero-downtime email migration, Teams & SharePoint setup, Intune MDM, and zero-trust security for Canadian SMBs and enterprises." path="/services/microsoft-365" />
