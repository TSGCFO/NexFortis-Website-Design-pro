...
export default function DigitalMarketing() {
  ...
  return (
    <div>
      <SEO title="Digital Marketing & Web Design" description="Full-service digital marketing for Canadian businesses: custom web design, SEO, Google Ads management, and content that converts site visitors into customers." path="/services/digital-marketing" />
