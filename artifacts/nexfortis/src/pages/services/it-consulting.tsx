...
export default function ITConsulting() {
  ...
  return (
    <div>
      <SEO title="IT Consulting & Project Management" description="Virtual CIO services, IT consulting, technology audits, and project management for Canadian businesses. Cut costs, close security gaps, modernize your stack." path="/services/it-consulting" />
