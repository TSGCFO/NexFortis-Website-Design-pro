  ...
  return (
    <div>
      <SEO
        ...
        description="Terms of Service for NexFortis IT Solutions — 17756968 Canada Inc. Read the terms governing our IT services, software products, and website use."
        path="/terms"
      />
      <BreadcrumbSchema
        items={[
