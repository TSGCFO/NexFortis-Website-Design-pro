    ...
    <div>
      ...
      <Section bg="white">
        <div className="max-w-3xl mx-auto prose prose-blue lg:prose-lg text-muted-foreground prose-headings:text-foreground">
          ...
          <h2>Services, products, and payment</h2>
          ...
          <h2>Intellectual property, confidentiality, and data</h2>
          ...
          <h3>8. Data Handling and Privacy</h3>
          <p>
          ...
          <h2>Liability, indemnification, and termination</h2>
