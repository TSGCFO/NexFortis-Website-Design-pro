...
export default function Contact() {
  ...
  return (
    <div>
      <SEO title="Contact Us — Free IT Consultation" description="Get in touch with NexFortis IT Solutions in Nobleton, Ontario. Request a free IT consultation, ask about our services, or schedule a discovery call today." path="/contact" />
      <BreadcrumbSchema
        items={[
          { name: "Home", url: "/" },
          ...
          <div className="lg:col-span-3 bg-card p-8 md:p-12 rounded-3xl shadow-xl border border-border">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" noValidate>
              ...
              <button
                ...
                className="w-full py-4 min-h-[48px] rounded-xl bg-rose-gold text-rose-gold-foreground font-bold text-lg hover:bg-rose-gold-hover hover:shadow-lg shadow-rose-gold/20 transition-all disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  <>
