  ...
  return (
    <div>
      <SEO
        ...
        description="Expert IT advice, managed services guides, QuickBooks migration tips, Microsoft 365 how-tos, and digital marketing insights from the NexFortis team in Canada."
        path="/blog"
        type="website"
      />
      <BreadcrumbSchema
