  ...
  return (
    <div>
      <SEO
        ...
        description="Managed IT services for Canadian businesses: digital marketing, Microsoft 365, QuickBooks migration, IT consulting, and workflow automation under one roof."
        path="/services"
      />
      <BreadcrumbSchema
        items={[
