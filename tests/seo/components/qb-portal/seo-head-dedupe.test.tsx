/**
 * Unit coverage for the SeoHeadDedupe runtime guard (qb-portal).
 *
...
describe("SeoHeadDedupe", () => {
  test("collapses duplicate canonical/hreflang/description/og/title to the last copy", async () => {
    ...
    addLink("canonical", "https://qb.nexfortis.com/stale");
    addLink("alternate", "https://qb.nexfortis.com/stale", "en-CA");
    addMeta("name", "description", "stale description");
    addMeta("property", "og:url", "https://qb.nexfortis.com/stale");
    addTitle("Stale Title");

    // helmet appends its own copies after hydration.
    const freshCanonical = addLink("canonical", "https://qb.nexfortis.com/fresh");
    addLink("alternate", "https://qb.nexfortis.com/fresh", "en-CA");
    addMeta("name", "description", "fresh description");
    addMeta("property", "og:url", "https://qb.nexfortis.com/fresh");
  ...
  test("keeps distinct hreflang alternates (different hreflang are not duplicates)", async () => {
    ...
    addLink("alternate", "https://qb.nexfortis.com/x", "en-CA");
    addLink("alternate", "https://qb.nexfortis.com/x", "x-default");
    // A real duplicate to force an observer pass.
    addLink("canonical", "https://qb.nexfortis.com/a");
    addLink("canonical", "https://qb.nexfortis.com/b");
